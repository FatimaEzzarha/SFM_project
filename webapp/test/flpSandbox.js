		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#sfmsalesproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sfmsalesproject-display": {
								"semanticObject": "sfmsalesproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sfm.salesproject",
									"url": sap.ui.require.toUrl("sfm/salesproject")
								}
							}
						}
					}
